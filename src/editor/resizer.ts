import { resizerStyle, MIN_RESIZER_DISTANCE, RESIZER_SIDE_LENGTH, SVGNS } from './constant';
import { Dimension, Point } from './math';
import { cssVisible, toCSSString, CSSStyle } from './shape/style';
import { createShapeResizerId, ShapeIdentifier } from './shape/type';
...
export class ResizerElement {
  ...
  // === Lifecycle ================================================================
  public constructor(svgEditor: SVGEditor, id: ShapeIdentifier, resizer: Resizer) {
  ...
  // ------------------------------------------------------------------------------
  public static createResizerElements(svgEditor: SVGEditor, id: ShapeIdentifier, resizers: Resizers) {
    return Object.fromEntries(Object.values(ResizerLocation).map(location => ([location, new ResizerElement(svgEditor, id, resizers[location])]))) as Record<ResizerLocation, ResizerElement>;
  }
