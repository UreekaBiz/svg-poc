...
import { computeBoxCenter, computeCenterDimensionFromBox, computeOrientedBoxFromCenterDimension, rotateBox, rotatePoint, Dimension, Point } from '../../math';
import { isBottom, isLeft, isRight, isTop, Resizer } from '../../resizer';
...
export class ResizeTool extends AbstractTool implements Subtool {
   ...
   * @see #destroy()
   */
  public constructor(svgEditor: SVGEditor, toolbar: Toolbar, private startingPoint: Point, private contentEntry: ContentEntry, private resizer: Resizer) {
  ...
  private mouseMove(event: MouseEvent) {
    let mousePosition = getMousePosition(event, this.svgEditor);
